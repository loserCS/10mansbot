...
de_cbble = Map('Cobblestone', 'de_cbble', '<:de_cobblestone:784221658704904193>',
               f'{BASE_URL}cobblestone.jpg')
de_dust2 = Map('Dust II', 'de_dust2', '<:de_dust2:784221660001206272>',
               f'{BASE_URL}dust-ii.jpg')
de_inferno = Map('Inferno', 'de_inferno', '<:de_inferno:784221660000681985>',
                 f'{BASE_URL}inferno.jpg')
de_mirage = Map('Mirage', 'de_mirage', '<:de_mirage:784221659590164480>',
                f'{BASE_URL}mirage.jpg')
de_nuke = Map('Nuke', 'de_nuke', '<:de_nuke:784221659787165737>',
              f'{BASE_URL}nuke.jpg')
de_overpass = Map('Overpass', 'de_overpass', '<:de_overpass:784221659539177482>',
                  f'{BASE_URL}overpass.jpg')
de_train = Map('Train', 'de_train', '<:de_train:784221659451752449>',
